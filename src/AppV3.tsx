...
type Mode = 'welcome' | 'signup' | 'signin' | 'onboarding' | 'home' | 'discover'
  ...
  if (mode === 'discover' && session) {
    return (
      <Discover
        ...
        onBack={() => setMode('home')}
        onEditProfile={() => setMode('onboarding')}
      ...
      <main className="page-shell">
        <section className="hero-card dashboard-card">
          ...
          <p className="hero-copy">
            Your profile is ready. Discover people whose friendship goals and writing
            habits fit naturally with yours.
          </p>
          ...
          <div className="actions dashboard-actions">
            ...
            <button className="secondary" onClick={() => setMode('onboarding')}>Edit profile</button>
          </div>
        </section>
      </main>
    )
