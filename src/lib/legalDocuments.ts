...
export const LEGAL_EFFECTIVE_DATE_LABEL = 'September 13, 2026'
...
export const legalDocuments: LegalDocument[] = [
  {
    ...
    summary: 'The rules for creating an account and using OutKin as a friendship-first correspondence service.',
    sections: [
      {
        heading: '1. Agreement and eligibility',
        paragraphs: [
          'These Terms of Service govern your use of OutKin. By creating or using an account, you agree to these Terms and the Community Guidelines. If you do not agree, do not use the service.',
          'OutKin is currently for adults age 18 and older. You must be legally able to enter into this agreement where you live. Do not create an account for another person without authorization.',
        ],
      },
      {
        heading: '2. What OutKin is for',
        paragraphs: [
          'OutKin is a friendship-first service for platonic pen-pal relationships and meaningful one-to-one correspondence. It supports digital letters and, when both members choose, a consent-based transition to physical mail.',
          'OutKin is not a dating, hookup, sexual-services, employment, financial-services, marketplace, or emergency-response platform. Compatibility scores and profile information are aids for discovery, not guarantees about another member, their identity, or the quality or safety of a future friendship.',
        ],
      },
      {
        ...
        bullets: [
          ...
          'Use one account per person unless OutKin explicitly authorizes otherwise.',
          'Do not sell, transfer, rent, or share access to your account.',
          'Tell OutKin support promptly if you believe your account has been compromised.',
          'You are responsible for activity performed through your account unless caused by an OutKin security failure.',
        ],
      },
      {
        heading: '4. Member conduct',
        paragraphs: [
          'You must follow the Community Guidelines and all applicable laws. You may not use OutKin to harass, threaten, exploit, deceive, impersonate, stalk, dox, spam, scam, solicit sexual activity, seek romantic or hookup partners, distribute illegal content, or evade a block or moderation action.',
      ...
      },
      {
        ...
        paragraphs: [
          'You keep ownership of content you create, including profile text, photos, and letters. You give OutKin a limited, non-exclusive license to host, store, process, display, transmit, resize, and otherwise use that content only as reasonably necessary to operate, secure, moderate, improve, and support the service.',
          ...
          'Private correspondence is not public content. Authorized moderation staff may review relevant correspondence when reasonably necessary to investigate a report, safety issue, abuse concern, or support request. OutKin is designed to audit such moderation access where supported by the moderation tools.',
        ],
      },
      {
        heading: '6. Photos, privacy, and identity',
        paragraphs: [
          'Profile photos are optional and are not identity verification. OutKin does not currently perform government-ID verification, criminal background checks, or guarantee that profile claims are true.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'OutKin cannot control physical mail after an address has been disclosed. Revoking access, ending a pen-pal relationship, or blocking a member stops normal in-app access but cannot retrieve an address the recipient already copied or remembered.',
        ],
      ...
      },
      {
        ...
        paragraphs: [
          'OutKin may investigate reports and take proportionate action including warnings, feature restrictions, temporary suspensions, content or photo removal, or account bans. Serious or repeated violations may result in immediate restriction without a prior warning.',
      ...
      },
      {
        ...
        paragraphs: [
          'OutKin is under active development. Features may change, be interrupted, be limited, or be discontinued. We do not promise uninterrupted availability, delivery of any particular letter or notification, or permanent preservation of optional features.',
      ...
      },
      {
        ...
        paragraphs: [
          'OutKin relies on third-party infrastructure providers for functions such as hosting, authentication, storage, security, and communications. Their services may have their own terms and availability limitations. OutKin is not responsible for independent third-party services you choose to use outside the app, including postal carriers or mailbox providers.',
        ],
      },
      {
        heading: '11. Disclaimers',
        paragraphs: [
          'To the extent permitted by law, OutKin is provided on an “as is” and “as available” basis. We do not warrant that every member is who they claim to be, that every friendship will be safe or successful, or that the service will be error-free or uninterrupted.',
      ...
      },
      {
        ...
        paragraphs: [
          'To the extent permitted by applicable law, OutKin and its operator will not be liable for indirect, incidental, special, consequential, exemplary, or punitive damages arising from use of the service or interactions between members. Any limitation applies only to the extent the law allows and does not limit liability that legally cannot be limited.',
        ],
      },
      {
      ...
      },
      {
        heading: '14. Contact',
        paragraphs: [
          'For account, privacy, moderation, or Terms questions, use the Help Center and private support conversation tools inside OutKin. Public contact information may be added as the service establishes a separate business or legal contact address.',
        ],
      },
    ],
  },
  {
    ...
    effectiveDate: LEGAL_EFFECTIVE_DATE,
    requiredAcceptance: true,
    summary: 'What OutKin collects, why it uses it, who can see it, and the controls members have over their information.',
    sections: [
      {
        heading: '1. Scope',
        paragraphs: [
          'This Privacy Policy explains how OutKin handles personal information when you create an account, build a profile, discover pen pals, exchange letters, use safety tools, contact support, or choose to exchange physical mailing addresses.',
          'OutKin is currently an 18+ service. It is not intended for children or minors.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'OutKin currently uses browser storage for limited app state, authentication/session operation, and local drafts. Unsent letter drafts and unfinished profile edits may be stored locally in the browser on the device where you created them. Those local drafts are not the same as a sent letter or saved server-side profile.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Maintain, debug, improve, and protect OutKin.',
        ],
      },
      {
        ...
        paragraphs: [
          ...
          'Profile-photo visibility can be limited. A mailing address is disclosed to a specific established pen pal only after the applicable consent flow and your separate decision to share it. The recipient may then be able to copy that information outside OutKin.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'OutKin uses infrastructure and service providers to host data, authenticate users, store files, secure the service, and support app operation. Those providers process information on OutKin’s behalf according to their role and applicable agreements.',
          'We may disclose information when reasonably necessary to comply with law, legal process, protect a person from serious harm, investigate fraud or abuse, defend legal rights, or protect the security and integrity of OutKin.',
          'OutKin does not sell member personal information and does not provide member conversations or mailing addresses to advertisers for targeted advertising.',
        ],
      },
      {
      ...
      },
      {
        heading: '10. Security',
        paragraphs: [
          'OutKin uses access controls, database row-level security, protected server functions, private storage rules, and other technical safeguards appropriate to the current service. No online service can guarantee absolute security. Protect your password, use a secure device, and report suspected account compromise promptly.',
        ],
      },
      {
        heading: '11. International processing',
        paragraphs: [
          'OutKin is designed for international friendships. Depending on where you live and where service providers operate, information may be processed in another country. Applicable privacy rights continue to apply according to law.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'OutKin records the policy document, version, time, and acceptance source when you agree to a required version of the Terms, Privacy Policy acknowledgement, or Community Guidelines. We do not need to store your IP address in the legal-acceptance record for the current public early-access implementation.',
        ],
      },
      {
        heading: '14. Changes and contact',
        paragraphs: [
          'We may update this Privacy Policy as OutKin changes. A material version change may require a new acknowledgement in the app. For privacy questions, use Help → Contact support and choose the privacy category.',
        ],
      },
    ],
  },
  {
    ...
    effectiveDate: LEGAL_EFFECTIVE_DATE,
    requiredAcceptance: true,
    summary: 'The behavior standards that keep OutKin focused on respectful, platonic friendship and safe correspondence.',
    sections: [
      {
        heading: '1. Friendship first',
        paragraphs: [
          'OutKin exists for genuine platonic friendship. Do not use the service to seek dates, hookups, romantic partners, sexual partners, commercial companionship, or sexual services.',
          'Friendships can naturally evolve in ways a platform cannot predict, but members may not use OutKin’s discovery, requests, profiles, or correspondence tools as a dating or sexual-solicitation system.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'Do not send or solicit pornography, explicit sexual content, sexualized nudity, sexual services, coercive sexual messages, or non-consensual intimate content. OutKin is an adult service, but “18+” does not make explicit sexual use appropriate here.',
        ],
      },
      {
        ...
        bullets: [
          ...
          'Do not use OutKin to harvest email addresses, mailing addresses, photos, or other member data.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'Do not use OutKin to facilitate illegal activity, credible violence, trafficking, exploitation, malicious hacking, distribution of illegal goods, or instructions intended to cause serious harm. Do not use physical mail arranged through OutKin to send illegal, dangerous, threatening, or prohibited items.',
        ],
      },
      {
        heading: '9. Adults only',
        paragraphs: [
          'Members must be 18 or older. Do not create an account for a minor, invite a minor to use an adult account, or use OutKin to seek contact with minors. Report an account if you reasonably believe the user is under 18.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'OutKin may consider severity, context, evidence, prior behavior, risk to others, and attempts to evade enforcement. Actions may include warnings, content or photo removal, temporary suspension, permanent bans, and other restrictions available in the service.',
        ],
      },
    ],
  },
  {
    ...
    summary: 'Practical ways to build trust gradually, protect personal information, recognize scams, and use OutKin safety tools.',
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          'OutKin profile photos are not verified identity documents. Reverse-image searches, video calls, or outside research may provide additional context, but none of those methods guarantees safety. Never pressure another member to prove their identity by sending sensitive documents.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          'Use Block when you want normal contact to stop. Use Report when moderation should review potential rule violations or safety concerns. For immediate threats or emergencies, contact local emergency services or law enforcement; OutKin support is not an emergency-response service.',
        ],
      },
    ],
  },
  {
    ...
    effectiveDate: LEGAL_EFFECTIVE_DATE,
    requiredAcceptance: false,
    summary: 'What is allowed in an OutKin profile photo and how photo privacy and moderation work.',
    sections: [
      {
        heading: 'Photos are optional',
        paragraphs: [
          'You do not need a profile photo to participate in OutKin. A photo is a social cue, not proof that a member’s name, age, location, or identity has been verified.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Advertising, spam, QR codes, or contact information primarily intended to bypass OutKin safety controls.',
      ...
      },
      {
        ...
        paragraphs: [
          'When a member reports a profile photo, OutKin may preserve the exact reported image as private moderation evidence. Replacing or hiding the current photo does not rewrite the evidence attached to an earlier report. Photo evidence may be retained as reasonably necessary for moderation, safety, audit integrity, or legal obligations.',
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Revoking an address share, ending the pen-pal relationship, or blocking a member removes normal in-app access to the shared address. OutKin cannot erase a copy the recipient already wrote down, printed, photographed, memorized, or saved elsewhere.',
      ...
      },
      {
        ...
        paragraphs: [
          'Cross-border address exchange is available only when the app’s current consent requirements are met. International mail may reveal additional customs information and can be subject to inspection, delays, fees, import restrictions, or local postal rules outside OutKin’s control.',
        ],
      },
      {
        heading: 'Staff access and support',
        paragraphs: [
          'Mailing addresses are not displayed in ordinary moderator member search or case-file tools. Infrastructure administrators may still have technical access when necessary to operate, secure, restore, or legally administer the service. If physical mail becomes threatening or abusive, use OutKin reporting tools and consider contacting your postal carrier or local authorities when appropriate.',
        ],
      },
    ],
  },
